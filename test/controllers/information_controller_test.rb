...
class InformationControllerTest < ActionController::TestCase
  ...
  test "should create information" do
    assert_difference('Information.count') do
      post :create, information: { description: @information.description, title: @information.title, user_id: @information.user_id }
    end
  ...
  test "should update information" do
    patch :update, id: @information, information: { description: @information.description, title: @information.title, user_id: @information.user_id }
    assert_redirected_to information_path(assigns(:information))
  end
